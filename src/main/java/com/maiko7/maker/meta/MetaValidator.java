...
import com.maiko7.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "maiko7");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.maiko7");
