...
public class TemplateMaker {
     ...
     * @param templateMakerModelConfig
     * @param sourceRootPath C:\Users\73450\Desktop\maiko7-generator-master\yuzi-generator-maker\.temp\1\springboot-init
     * @return
     */
    private static List<Meta.FileConfig.FileInfo> makeFileTemplates(TemplateMakerFileConfig templateMakerFileConfig, TemplateMakerModelConfig templateMakerModelConfig, String sourceRootPath) {
        ...
        for (TemplateMakerFileConfig.FileInfoConfig fileInfoConfig : fileConfigInfoList) {
            ...
            if (!inputFilePath.startsWith(sourceRootPath)) {
                //C:\Users\73450\Desktop\maiko7-generator-master\yuzi-generator-maker\.temp\1\springboot-init\src/main/resources/application.yml
    ...
    private static Meta.FileConfig.FileInfo makeFileTemplate(TemplateMakerModelConfig templateMakerModelConfig, String sourceRootPath, File inputFile, TemplateMakerFileConfig.FileInfoConfig fileInfoConfig) {
         ...
         * 比如"D:/Yupi/yuzi-generator-master/yuzi-generator-demo-projects/acm-template-pro","src/com/yupi/acm/MainTemplate.java.ftl",
        ...
        for (Map.Entry<String, List<Meta.FileConfig.FileInfo>> entry : groupKeyFileInfoListMap.entrySet()) {
            ...
            List<Meta.FileConfig.FileInfo> newFileInfoList = new ArrayList<>(tempFileInfoList.stream()
                    ...
                    .collect(
                             ...
                             * 举个例子就是假设key是"inputPath": "src/com/yupi/acm/MainTemplate.java", value是下面这个
                             * {
                             *         "inputPath": "src/com/yupi/acm/MainTemplate.java",
                             *         "outputPath": "src/com/yupi/acm/MainTemplate.java.ftl",
                             *         "type": "file",
